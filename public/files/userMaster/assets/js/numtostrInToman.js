...
"use strict";
var delimiter = " و ", zero = "صفر", negative = "منفی ",
    letters = [["", "یک", "دو", "سه", "چهار", "پنج", "شش", "هفت", "هشت", "نه"]
    ...
    prepareNumber = function (e) {
        ...
        return "number" == typeof t && (t = t.toString()),
            t.length % 3 == 1 ? t = "00".concat(t) : t.length % 3 == 2 && (t = "0".concat(t)),
    ...
    tinyNumToWord = function (e) {
        ...
        var i = t % 10, u = (t - t % 100) / 100, s = (t - (100 * u + i)) / 10, a = [letters[3][u]], o = 10 * s + i;
        return 0 === o ? a.join(delimiter) : (o < 10 ? a.push(letters[0][o]) : o <= 20 ? a.push(letters[1][o - 10]) : (a.push(letters[2][s]),
        i > 0 && a.push(letters[0][i])), a.join(delimiter))
    },
    ...
    Num2persian = function (e) {
        ...
        return n.length > 0 && (n = convertDecimalPart(n)), (t ? negative : "") + a.join(delimiter) + n + ' تومان'
    };
String.prototype.toPersianLetter = function () {
    console.log(Num2persian(this))
