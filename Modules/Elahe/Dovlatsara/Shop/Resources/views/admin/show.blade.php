...
@section('urlHeader')جزییات اطلاعات فروشگاه
@endsection
@section('header')
    {{--    {!! $map !!}--}}
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <h1 class="card-title" style="float: right">فروشگاه {{$shop->title}}</h1>
            </div>
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header text-bold" style="color: violet">جزییات فروشگاه</div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
