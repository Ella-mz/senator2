                ...
                <div class="search-box">
                    <div class="row">
                        ...
                        <div class="input-box my-4 px-3 justify-content-center product-search-box-parent">
                            {{--                            <div class="row">--}}
                            <form id="searchCategory" method="get"
                                  class="product-search-box-form">
                                {{--                                @csrf--}}
                                <select name="categoryInForm">
                                ...
                                <button onclick="searchCat()" class="RecBtn red">جستجو</button>
                            </form>
                            <br>
                            {{--                            </div>--}}
                                        ...
                                        @foreach($attributeGroups as $attrGroup)
                                            @foreach($attrGroup->attributes->where('isFilterField', 1) as $attr)
                                                ...
                                                <span class="box-header-sidebar activeacc"><i
                                                        ...
                                                        <div class="catalog" style="display: none;">
                                                            <div class="select-box">
                                                                <select class="js-example-basic-multiple attributeTypeSelect"
                                                                        style="width: 100%;"
                                                                            ...
                                                                            @foreach($categories as $cat1)
                                                                                <li>
                                                                                    <div class="catModal">
                                                                                        ...
                                                                                        <i class="fa fa-angle-left"></i>
                                                                                        <label
                                                                                            for="m{{$cat1->id}}">{{$cat1->title}}</label>
                                                                                    </div>
                                                                                    <div class="show-more">
                                                                                        @foreach($cat1->categories as $cat_sub_1)
                                                                                            <div class="catModal">
                                                                                                ...
                                                                                                <span
                                                                                                    class="catalog-cat-item"><i
                                                                                                        ...
                                                                                                        for="m{{$cat_sub_1->id}}">{{$cat_sub_1->title}}</label></span>
                                                                                            </div>
                                                                                            <ul class="catalog-list">
                                                                                                @foreach($cat_sub_1->categories as $cat_sub_2)
                                                                                                    ...
                                                                                                    <li class="catModal">
                                                                                                        ...
                                                                                                        <a
                                                                                                            class="catalog-link">
                                                                                                            <label
                                                                                                                for="m{{$cat_sub_2->id}}">{{$cat_sub_2->title}}</label></a>
                                                                                                    </li>
                                                                                                @endforeach
        ...
        function searchCat() {
            $('#attributes_form_filter_page').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    type: "GET",
                    data: {
                        'categoryInForm': $('select[name=categoryInForm]:checked').val(),
            ...
            $('#attributes_form_filter_page').on('submit', function (event) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#firstPageFilterAdvertiser1Div').append(data.content);
                        $('#attrFilter').empty();
                        $('#attrFilter').append(data.attributeGroups);
                    }
                })
            });
        });
    ...
    <script>
        $(document).ready(function () {
            $('#attributes_form_modal').on('submit', function (event) {
                event.preventDefault();
                console.log($('input[name=categoryInModal]:checked').val())
                // var formData = {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'categoryInFormModal': $('input[name=categoryInModal]:checked').val(),
