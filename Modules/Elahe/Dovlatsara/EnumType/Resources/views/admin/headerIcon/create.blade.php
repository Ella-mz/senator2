            ...
            <div class="col-md-10" style="margin-left: 7%; margin-bottom: 1%">
                <div class="card card-primary">
                    <div class="card-header d-flex align-content-start justify-content-start" >
                        <h1 class="card-title">ایجاد آیکون جدید</h1>
                    </div>
                    <form action="{{ route('header_icon.store.admin') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end align-content-end" style=" margin-bottom: 2%">
                            ...
                            <a href="{{route('header_icon.index.admin')}}" class="btn btn-secondary" style="margin-left:1%">لغو</a>
                        </div>
                    </form>
                </div>
            </div>
