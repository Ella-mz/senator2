            ...
            <div class="col-md-10" style="margin-left: 7%; margin-bottom: 1%">
                <div class="card card-primary">
                    <div class="card-header d-flex align-content-start justify-content-start" >
                        <h1 class="card-title">تماس با ما</h1>
                    </div>
                    <form action="{{ route('contactUs.store.admin') }}" method="post">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                @if(isset($contactUs->description))
                                    <textarea class="form-control" rows="5" type="text"
                                              name="description"
                                              placeholder="توضیحات خود را در این مکان وارد کنید.">{{$contactUs->description}}</textarea>
                                @else
                                    <textarea class="form-control" rows="5" type="text"
                                              name="description"
