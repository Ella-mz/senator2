...
@section('urlHeader')ویرایش مقاله
@endsection
@section('header')
        ...
        <div class="row">
            ...
            <div class="col-md-10" style="margin-left: 7%; margin-bottom: 1%">
                <div class="card card-primary">
                    ...
                    <form action="{{ route('articles.update.admin', $article->id) }}"
                        ...
                        <div class="d-flex justify-content-end align-content-end" style=" margin-bottom: 2%">
                            <button type="submit" class="btn btn-success float-right">ویرایش مقاله</button>
