...
@section('urlHeader')ایجاد مقاله جدید
@endsection
@section('header')
@endsection
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-10" style="margin-left: 7%; margin-bottom: 1%">
                <div class="card card-primary">
                    ...
                    <form action="{{ route('articles.store.admin') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end align-content-end" style=" margin-bottom: 2%">
                            <button type="submit" class="btn btn-success float-right">ایجاد مقاله</button>
                            <a href="{{route('articles.index.admin', $articleGroup->slug)}}" class="btn btn-secondary"
