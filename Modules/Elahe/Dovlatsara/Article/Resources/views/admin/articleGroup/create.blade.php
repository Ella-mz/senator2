...
@section('urlHeader')ایجاد گروه مقاله جدید
@endsection
@section('header')
            ...
            <div class="col-md-10" style="margin-left: 7%; margin-bottom: 1%">
                <div class="card card-primary">
                    <div class="card-header d-flex align-content-start justify-content-start" >
                        ...
                        <h1 class="card-title">گروه مقاله جدید</h1>
                    </div>
                    <form action="{{ route('article-groups.store.admin') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end align-content-end" style=" margin-bottom: 2%">
                            <button type="submit" class="btn btn-success float-right">ایجاد گروه مقاله</button>
                            <a href="{{route('article-groups.index.admin')}}" class="btn btn-secondary" style="margin-left:1%">لغو</a>
                        </div>
