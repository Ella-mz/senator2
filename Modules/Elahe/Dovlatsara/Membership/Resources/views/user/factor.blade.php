...
@section('content_userMasterNew')
    <main class="invoice-main-page">
        <section class="invoice-page">
            <form method="post" action="{{route('membership.pay.user')}}">
                @csrf
                <input hidden name="id" value="{{$membership->id}}">
                <div id="isWallet">
                </div>
            <div class="container">
...
{{--                            </li>--}}
                            <li>
                                <p class="title">میزان امتیاز:</p>
                                <span>{{$membership->score}}</span>
                            </li>
                            <li>
                                <p class="title">مبلغ:</p>
                                <span>{{number_format(substr($membership->price, 0, -1)) }} تومان</span>
                            </li>
                            <li>
