...
@section('title_realestate')هولوگرام های من
@endsection
@section('card_title')هولوگرام های من
@endsection
                                                        ...
                                                        <table id="example1" class="table table-bordered table-hover table-sm display responsive nowrap">
                                                            ...
                                                            @foreach($ad_holograms as $key=>$hologram)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a type="button"
                                                                           href="{{route('hologram.myHologram.realestate', $hologram->id)}}"
                                                                           class="btn btn-sm"
                                                                           style="background-color: #3c3cce;color: #fff"><i
                                            ...
                                            <div class="col-10">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body p-0">
                                                        ...
                                                        <table id="example2" class="table table-bordered table-hover table-sm display responsive nowrap" style="width: 100%">
                                                            <thead>
                                                            <tr>
                                                                <th>ردیف</th>
