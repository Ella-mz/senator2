...
@section('content_realestateMaster')
    <main class="invoice-main-page">
        <section class="invoice-page">
            <form method="post" action="{{route('hologram.pay.realestate')}}" id="factorForm">
                @csrf
                <input hidden name="id" value="{{$hologram_interface->id}}">
                <div id="isWallet">
                </div>
                <div class="container">
                    <div class="show-invoice">
                        <div class="invoice-title">
                            <h3><strong>پرداخت هزینه هولوگرام
                                </strong></h3>
                        </div>
                        ...
                        <div class="invoice-info-box">
                            <ul>
                                <li>
                                    <p class="title">هولوگرام:</p>
                                    <span>{{$hologram->title}}</span>
                                </li>
                                <li>
                                    <p class="title">نوع هولوگرام:</p>
                                    <span>
                                        @if($hologram->type=='ad')
                                            ویژه آگهی
                                ...
                                <li>
                                    ...
                                    <span>{{number_format(substr($hologram->price, 0, -1)) }} تومان</span>
                                </li>
                                <li>
