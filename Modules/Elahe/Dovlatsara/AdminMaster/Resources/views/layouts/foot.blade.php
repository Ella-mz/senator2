...
<!-- jQuery UI 1.11.4 -->
{{--<script src2="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"></script>--}}
...
<!-- Morris.js charts -->
{{--<script src2="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>--}}
...
<!-- daterangepicker -->
{{--<script src2="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"></script>--}}
...
{{--<script src2="{{asset('files/adminMaster/dist/js/pages/dashboard.js')}}"></script>--}}
<!-- AdminLTE for demo purposes -->
{{--<script src2="{{asset('files/adminMaster/dist/js/demo.js')}}"></script>--}}

{{--<script src2="https://cdn.datatables.net/responsive/2.2.6/js/dataTables.responsive.min.js"></script>--}}
