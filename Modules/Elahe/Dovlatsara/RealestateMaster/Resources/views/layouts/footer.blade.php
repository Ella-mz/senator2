...
{{--                <a href="#">--}}
{{--                    <img src="assets/images/footer-img/1090a120.png">--}}
{{--                    <img src="assets/images/footer-img/71abe5c9.png">--}}
{{--                </a>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
...
{{--                <p>--}}
{{--                    استفاده از مطالب فروشگاه اینترنتی دیجی‌استور فقط برای مقاصد غیرتجاری و با ذکر منبع--}}
{{--                    بلامانع است. کلیه حقوق این سایت متعلق به شرکت نوآوران فن آوازه (فروشگاه آنلاین دیجی‌استور) می‌باشد.--}}
{{--                </p>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
