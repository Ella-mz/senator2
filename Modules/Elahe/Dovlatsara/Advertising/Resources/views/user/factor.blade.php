...
@section('content_userMasterNew')
    <main class="invoice-main-page">
        <section class="invoice-page">
            <form method="post" action="{{route('advertisement.pay.user')}}" id="factorForm">
                @csrf
                ...
                <div class="container">
                    <div class="show-invoice">
                        ...
                        تبلیغ شما از تاریخ {{verta($advertisingApplication->startDate)->formatJalaliDate()}} تا تاریخ {{verta($advertisingApplication->endDate)->formatJalaliDate()}} معتبر خواهد بود
                    </div>
                    <div class="show-invoice">
                        <div class="invoice-info-box">
                            ...
                            <span
                                style="color: #21cc8d; margin-left: 215px" id="walletBalance">موجودی کیف پول شما: {{number_format($current_balance>0?substr($current_balance, 0, -1):0)}} ریال</span><br>
