...
@section('title_realestate') {{$advertising->title}}
@endsection
@section('card_title') {{$advertising->title}}
@endsection
                ...
                <div class="col-md-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{route('advertisings.apply.submit.realestate')}}"
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            jQuery('select[name="category"]').on('change', function () {
                ...
                if (categoryId) {
                    jQuery.ajax({
                        url: "{{route('getDates.index.realestate')}}",
                        data: {
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            jQuery('select[name="user"]').on('change', function () {
                ...
                if (userId) {
                    jQuery.ajax({
                        url: "{{route('getDates.user.index.realestate')}}",
                        data: {
                            'userId': userId,
                            'advertisingId': '{{$advertising->id}}'
                        },
