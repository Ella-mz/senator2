...
use Modules\Advertising\Http\Requests\Realestate\ApplyRequest;
...
class AdvertisingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Advertisings::realestate.index', compact('advertisings', 'pages'));
    }

    public function getImage()
    {
        $advertising = Advertising::find(request('advertisingID'));
        return json_encode(['status' => true, 'content' => '<img src2="' . asset($advertising->advertisingOrder->image) . '" alt="" style="width:100%; height:700px">']);
    ...
    public function apply($advertisingId)
    {
        ...
        return view('Advertisings::realestate.apply', compact('advertising', 'content', 'categories', 'agencies'));
    }
    ...
    public function applySubmit(ApplyRequest $request)
    {
        ...
        return view('Advertisings::realestate.factor', compact('advertising',
    ...
    {
        return view('Advertisings::realestate.startError');
    }

    public function callbackError()
    {
        return view('Advertisings::realestate.callbackError');
    }
}
