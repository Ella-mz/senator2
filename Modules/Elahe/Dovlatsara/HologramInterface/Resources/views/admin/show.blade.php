...
{{--                        @endif--}}
                    ...
                    <div class="col-md-6 text-left">
                        <a type="button" class="btn btn-info btn-sm"
                           href="{{route('hologramInterface.index.admin')}}"><i
                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-hover">
                                @if(isset($hologramInterface->expert_id))
                                    <tr>
                                        <th>نام و نام خانوادگی کارشناس</th>
                                        <td>{{\Modules\User\Entities\User::find($hologramInterface->expert_id)->name}}
                                            {{\Modules\User\Entities\User::find($hologramInterface->expert_id)->sirName}}</td>
                                    </tr>
                                @endif
                                ...
                                <table class="table table-hover">
                                    @foreach($hologramInterface->hologramInterfaceFiles as $key=>$file)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('hologramInterface.download.admin', $file->id)}}"
                                                   download
