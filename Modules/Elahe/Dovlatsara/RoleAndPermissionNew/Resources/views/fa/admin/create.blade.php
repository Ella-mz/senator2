                            ...
                            <div class="form-group">
                                ...
                                <select name="permissions[]" class="form-control select2" multiple="multiple">
                                    ...
                                    @foreach($permissions as $permission)
                                        <option value="{{$permission->id}}" @if(old('permissions') == $permission->id) selected @endif>{{$permission->name}}</option>
                                    @endforeach
                                </select>
...
{{--                                       autofocus >--}}
                        ...
                        <div class="d-flex justify-content-end align-content-end" style=" margin-bottom: 2%">
                            ...
                            <a href="{{route('roles.index')}}" class="btn btn-secondary" style="margin-left:1%">لغو</a>
                        </div>
                    </form>
                </div>
            </div>
