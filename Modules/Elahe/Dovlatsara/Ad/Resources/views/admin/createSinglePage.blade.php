                                    ...
                                    <div class="infoform ad-submit-forms" id="form-box1" data-content="first-infoform">
                                        ...
                                        <div class="first-info">
                                            <div class="first-info-box">
                                                <div class="row">
                                                    <div class="col-lg-12 ">
                                                        <span style="font-size: x-large;color: #ddb24f;font-weight: bolder">{{$category->createStringAsParents()}}</span>
...
{{--                                                                        <div id="app"></div>--}}
                                                                        ...
                                                                        {{--                                                                    <div class="card-body">--}}
                                                                        {{--                                                                        <div class="col-md-12">--}}
                                                                        <input name="latt" id="latt" hidden value="{{old('latt')}}">
                                                                        <input name="longg" id="longg" hidden value="{{old('longg')}}">
