...
@section('title_realestate')ویرایش آگهی
@endsection
@section('card_title')ویرایش آگهی
@endsection
@section('css')
            ...
            <div class="row mt-5">
                ...
                <div class="col-xl-9 mb-4">
                    <div style="background-color: #fff">
                        <form action="{{route('ad.update.supplier.panel', $ad->id)}}" method="post"
                                        ...
                                        <div class="first-info">
                                            <div class="first-info-box">
                                                <div class="row">
                                                    <div class="col-lg-12 ">
                                                        <span
                                                            style="font-size: x-large;color: #ddb24f;font-weight: bolder">{{$ad->category->createStringAsParents()}}</span>
...
{{--                                            @endif--}}
                                            ...
                                            <div class="form-agahi-btn">
                                                <a href="{{route('ad.index.supplier.realestate', auth()->id())}}"
...
@section('js_realestate')
        ...
        function deleteimage(id) {
            ...
            if (c) {
                jQuery(document).ready(function () {
                    if (id) {
                        jQuery.ajax({
                            url: '{{route('ad.deleteImage.panel')}}',
                            data: {
                                'id': id,
                            },
                            type: "GET",
        ...
        function deletevideo(id) {
            ...
            if (c) {
                jQuery(document).ready(function () {
                    if (id) {
                        jQuery.ajax({
                            url: '{{route('ad.deleteVideo.panel')}}',
                            data: {
                                'id': id,
                            },
                            type: "GET",
    ...
    <script type="text/javascript">
        jQuery(document).ready(function () {
            jQuery('select[id="adType"]').on('change', function () {
                ...
                // console.log(adType)
                jQuery.ajax({
                    url: "{{route('checkAdFee.realestate')}}",
                    data: {
    ...
    @if($ad->isPaid=='unpaid')
        <script type="text/javascript">
            jQuery(document).ready(function () {
                jQuery.ajax({
                    url: "{{route('show.chosen.AdFeeCard.panel')}}",
                    data: {
                        'adFeeId': null,
                        'cat_id': '{{$ad->category_id}}',
