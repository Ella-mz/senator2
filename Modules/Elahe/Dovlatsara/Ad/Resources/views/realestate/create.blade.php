...
@section('title_realestate')ایجاد آگهی جدید
@endsection
@section('card_title')ایجاد آگهی جدید
@endsection
@section('css')
            ...
            <div class="row mt-5">
                ...
                <div class="col-xl-9 mb-4">
                    <div style="background-color: #fff">
                        <form action="{{route('ad.store.supplier.realestate', $category->id)}}" method="post"
                                        ...
                                        <div class="first-info">
                                            <div class="first-info-box">
                                                <div class="row">
                                                    ...
                                                    {{--                                                    <div class="col-12 account-choice">--}}
                                                    {{--                                                        <div id="paymentCards">--}}
                                                ...
                                                @if($attrGroup->attributes->count() > 0)
                                                    ...
                                                    <div class="row justify-content-center align-items-baseline">
                                                        ...
                                                        @foreach($attrGroup->attributes as $attr)
                                                            <div
                                                                class="col-md-{{$attrGroup->numberOfColumnsForDisplay}} col-sm-6 mb-4 ">
...
@section('js_realestate')
    ...
    @if(old('city'))
        <script type="text/javascript">
            jQuery(document).ready(function () {
                jQuery.ajax({
                    url: "{{route('neighborhoodOld.panel')}}",
                    data: {
                        'cityId': '{{old('city')}}',
